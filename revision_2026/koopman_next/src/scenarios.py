...
def command_for(
    ...
    if name == "D2":
        ...
        if since < 5.0:
            return ScenarioCommand(0.0, sign * 3.5, -sign * 1.75, "STEP_PRIMARY")
        if since < 10.0:
            return ScenarioCommand(0.0, -sign * 3.5, sign * 1.75, "STEP_REVERSE")
        ...
        acceleration = (0.7**2 - speed_at_decel**2) / (2.0 * max(100.0 - distance_at_decel, 1e-12))
