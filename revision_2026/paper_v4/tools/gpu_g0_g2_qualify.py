"""Registered G0-G2 qualification for the isolated RTX 5080 predictor backend."""
...
def validate_protocol(protocol_path: Path, expected_sha: str, paper: Path) -> dict:
    ...
    if protocol.get("scope") != "RTX5080_G0_G2_ONLY_NO_CLOSED_LOOP":
...
def main() -> None:
    ...
    axis.axis("off")
    axis.text(0.02, 0.95, "G0 RTX 5080 environment qualification", fontsize=16, va="top")
    ...
    axes[0].bar(positions + 0.18, gpu_times, 0.36, label="RTX 5080 batch FD")
