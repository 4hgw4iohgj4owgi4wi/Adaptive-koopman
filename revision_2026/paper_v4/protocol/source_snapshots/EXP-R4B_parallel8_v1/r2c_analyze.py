...
def audit(label: str, folder: Path, expected_runner_sha256: str = "da2a33b6fcee6a975ae0561683720cc20d800a61c52cbd738fb165dfccafff82"):
    ...
    checks = {
        ...
        "source_identity": metrics["source_sha256"].lower() == expected_runner_sha256.lower(),
    }
    row = {
        "label": label,
        "folder": str(folder),
