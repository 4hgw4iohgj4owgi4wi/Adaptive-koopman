...
class EFDR12Config:
    project_root: Path
    protocol_sha256: str = "AC300D1791140D0465B94E906FE58A7A03A1AF89B7AB03360057B17441B61C85"
    base_candidates: tuple[int, ...] = (221000, 231000, 241000)
    horizon: int = 20
    ...
    def code_root(self) -> Path:
        return self.koopman / "innovation" / "efd_r12"

    @property
    def results(self) -> Path:
        return self.koopman / "innovation_efd_r12_results"
