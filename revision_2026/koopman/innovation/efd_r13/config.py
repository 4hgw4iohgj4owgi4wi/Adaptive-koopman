...
class EFDR13Config:
    project_root: Path
    protocol_sha256: str = "50641585C3DECA73AC4B68A55DD6EFCFBCB4FEA82CCA26B21DC29D33C7DF9343"
    base_candidates: tuple[int, ...] = (231000, 241000, 251000)
    horizon: int = 20
    ...
    def code_root(self) -> Path:
        return self.koopman / "innovation" / "efd_r13"

    @property
    def results(self) -> Path:
        return self.koopman / "innovation_efd_r13_results"
