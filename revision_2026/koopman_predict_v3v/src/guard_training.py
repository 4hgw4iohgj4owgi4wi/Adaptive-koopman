...
def train_phase(model,fit,inner,anchor_fit,anchor_inner,method,seed,identity,out,max_steps=15000,stop_at=None,resume=None,monitor_every=500,min_steps=2000,patience=2000,deadline=None,anchor_scale_m20=None):
