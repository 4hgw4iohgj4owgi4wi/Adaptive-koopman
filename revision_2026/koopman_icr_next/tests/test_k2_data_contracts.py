...
def test_d2_restores_r04_two_five_second_request_steps() -> None:
    ...
    assert (primary.virtual_front_deg, primary.virtual_rear_deg) == (5.0, -2.5)
    assert (reverse.virtual_front_deg, reverse.virtual_rear_deg) == (-5.0, 2.5)
...
def test_parallel_pair_executor_smoke() -> None:
    ...
    # Focus simulations must exercise the isolated candidate plant.  The frozen
    # connector_r3_4 tree is an identity/reference input and remains read-only.
    connector_src = source_root / "plant"
