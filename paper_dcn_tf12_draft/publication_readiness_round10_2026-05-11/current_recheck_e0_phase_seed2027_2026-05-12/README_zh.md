...
- 已包含实验：`E0`
- 是否达到正式 n>=20：`False`
- 数据目录：`D:\LEARNING\ZNN\ZNN\Adaptive-koopman\Adaptive-koopman-main\paper_dcn_tf12_draft\publication_readiness_round10_2026-05-11\current_recheck_e0_phase_seed2027_2026-05-12\data`
- 图片目录：`D:\LEARNING\ZNN\ZNN\Adaptive-koopman\Adaptive-koopman-main\paper_dcn_tf12_draft\publication_readiness_round10_2026-05-11\current_recheck_e0_phase_seed2027_2026-05-12\figures`
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| E0 | sine_mixed_fault_noise | tf14_phase_role | 1 | 0.0406 | 0.4686 | 1.000 | 0.3209 | 1.000 | 5.624e-03 |
