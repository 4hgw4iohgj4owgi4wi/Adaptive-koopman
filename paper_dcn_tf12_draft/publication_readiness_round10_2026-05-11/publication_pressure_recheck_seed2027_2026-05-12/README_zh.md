...
- 已包含实验：`E0`
- 是否达到正式 n>=20：`False`
- 数据目录：`D:\LEARNING\ZNN\ZNN\Adaptive-koopman\Adaptive-koopman-main\paper_dcn_tf12_draft\publication_readiness_round10_2026-05-11\publication_pressure_recheck_seed2027_2026-05-12\data`
- 图片目录：`D:\LEARNING\ZNN\ZNN\Adaptive-koopman\Adaptive-koopman-main\paper_dcn_tf12_draft\publication_readiness_round10_2026-05-11\publication_pressure_recheck_seed2027_2026-05-12\figures`
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| E0 | sine_publication_mixed_pressure | baseline | 1 | 0.0466 | 0.4739 | 1.000 | 0.1346 | 0.361 | -1.863e-02 |
| E0 | sine_publication_mixed_pressure | tf14_phase_role | 1 | 0.0424 | 0.5667 | 1.000 | 0.1348 | 0.780 | -1.318e-02 |
