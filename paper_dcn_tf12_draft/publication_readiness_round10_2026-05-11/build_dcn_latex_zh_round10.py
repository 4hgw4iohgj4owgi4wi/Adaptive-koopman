...
ROUND10 = DRAFT / "publication_readiness_round10_2026-05-11"
ROUND8 = DRAFT / "publication_readiness_round8_2026-05-11"
OUT = DRAFT / "dcn_latex_zh_round10_2026-05-11"
FIG_OUT = OUT / "figures"
NRKDCC_FIG = ROUND10 / "nrkdcc_support_figures" / "figures"
...
FIGURES = {
    ROUND8 / "e0_n20_mixed_fault_main_comparison" / "figures" / "R0_main_comparison_summary.png": "R0_main_comparison_summary.png",
    ROUND8 / "e0_n20_mixed_fault_main_comparison" / "figures" / "R0_error_timeseries.png": "R0_error_timeseries.png",
    ROUND10 / "e0_n20_comm_noise_key_main_comparison_merged" / "figures" / "R0_comm_key_main_comparison_summary.png": "R0_comm_key_main_comparison_summary.png",
    ROUND10 / "e0_n20_comm_noise_key_main_comparison_merged" / "figures" / "R0_comm_key_relative_change.png": "R0_comm_key_relative_change.png",
    NRKDCC_FIG / "fig_nrkdcc_team_center_trajectory.png": "fig_nrkdcc_team_center_trajectory.png",
    NRKDCC_FIG / "fig_nrkdcc_team_center_errors.png": "fig_nrkdcc_team_center_errors.png",
    NRKDCC_FIG / "fig_nrkdcc_vehicle_lateral_errors.png": "fig_nrkdcc_vehicle_lateral_errors.png",
    NRKDCC_FIG / "fig_nrkdcc_error_diagnostics.png": "fig_nrkdcc_error_diagnostics.png",
    NRKDCC_FIG / "fig_nrkdcc_mixed_ablation_summary.png": "fig_nrkdcc_mixed_ablation_summary.png",
    NRKDCC_FIG / "fig_nrkdcc_comm_ablation_summary.png": "fig_nrkdcc_comm_ablation_summary.png",
    NRKDCC_FIG / "fig_nrkdcc_certificate_summary.png": "fig_nrkdcc_certificate_summary.png",
    NRKDCC_FIG / "fig_nrkdcc_connection_force_audit.png": "fig_nrkdcc_connection_force_audit.png",
    NRKDCC_FIG / "fig_nrkdcc_koopman_training_loss.png": "fig_nrkdcc_koopman_training_loss.png",
    NRKDCC_FIG / "fig_nrkdcc_koopman_prediction_evidence.png": "fig_nrkdcc_koopman_prediction_evidence.png",
    NRKDCC_FIG / "fig_nrkdcc_delay_mechanism_evidence.png": "fig_nrkdcc_delay_mechanism_evidence.png",
    NRKDCC_FIG / "fig_nrkdcc_fdi_ftc_timeline.png": "fig_nrkdcc_fdi_ftc_timeline.png",
    NRKDCC_FIG / "fig_nrkdcc_modewise_certificate_closure.png": "fig_nrkdcc_modewise_certificate_closure.png",
    ROUND10 / "e2_n20_mixed_fault_ablation_merged" / "figures" / "R2_round10_module_ablation_heatmap.png": "R2_round10_module_ablation_heatmap.png",
    ROUND10 / "e2_n20_mixed_fault_ablation_merged" / "figures" / "R2_round10_key_module_effects.png": "R2_round10_key_module_effects.png",
    ROUND10 / "e2_n20_comm_noise_key_ablation_merged" / "figures" / "R2_comm_key_ablation_heatmap.png": "R2_comm_key_ablation_heatmap.png",
    ROUND10 / "e2_n20_comm_noise_key_ablation_merged" / "figures" / "R2_comm_key_effects.png": "R2_comm_key_effects.png",
    ROUND8 / "e3_n20_certificate" / "figures" / "R3_certificate_statistics.png": "R3_certificate_statistics.png",
    ROUND8 / "e7_n20_connection_safety" / "figures" / "R7_payload_connection_safety_sine_comm_noise_high.png": "R7_payload_connection_safety_sine_comm_noise_high.png",
    ROUND8 / "e7_n20_connection_safety" / "figures" / "R7_payload_connection_safety_sine_mixed_fault_noise.png": "R7_payload_connection_safety_sine_mixed_fault_noise.png",
}

AUTHOR_FIXES = {
    "cooperativeTransport2024ras": "Ebel, Henrik and Rosenfelder, Mario and Eberhard, Peter",
    "embeddedFormationTransport2024cep": "Wu, Quanwei and Wang, Xiangyu and Qiu, Xuechao",
    "multiObjectiveTransport2024mechatronics": "Zhao, Ruqing and Li, Fusheng and Lu, Xin and Lyu, Shubin",
    "intelligentCollaborativeTransport2024": "Li, X. and Lin, Y. and Du, Z. and others",
    "dosDMPC2024isa": "Zeng, Hao and Ye, Zehua and Zhang, Dan",
    "robustCommunicationLoss2025trb": "Yang, Lei and Sun, Zhanbo and Liu, Yafei and Chen, Linbin",
    "networkLatencyCav2024sensors": "Kamtam, Sidharth Bhanu and Lu, Qian and Bouali, Faouzi and Haas, Olivier C. L. and Birrell, Stewart",
    "convexRobustDMPC2025ejc": "Sun, Hao and Dai, Li and Fedele, Giuseppe and Chen, Boli",
}
...
本节给出与 TF14 模块一致的实践稳定性证明。证明目标不是全局渐近稳定，而是在有界模型误差、通信退化可恢复和 MPC 可行的条件下，闭环跟踪误差、连接误差和 lifted 预测误差一致最终有界。
...
\midrule
full TF14 & 1.00 & 0.0425 & 0.4709 & 0.0446\\
...
def _finalize_tex(text: str) -> str:
    """Remove local implementation-version wording from the visible manuscript."""
    replacements = [
        ("TF14-full", r"\Method{}"),
        ("TF14-main", r"\Method{} w/o role schedule"),
        ("full TF14", r"full \Method{}"),
        ("TF14 的", r"\Method{} 的"),
        ("TF14 在", r"\Method{} 在"),
        ("TF14 模块", r"\Method{} 模块"),
        ("TF14 相对", r"\Method{} 相对"),
...
def main() -> None:
    ...
    bib_src = ROUND10 / "core_references_round10.bib"
    if bib_src.exists():
        shutil.copy2(bib_src, OUT / "core_references_round10.bib")
        _sanitize_bib(OUT / "core_references_round10.bib")
    else:
        missing.append(str(bib_src))

    for src, dest_name in FIGURES.items():
        if src.exists():
            shutil.copy2(src, FIG_OUT / dest_name)
        else:
            missing.append(str(src))

    (OUT / "manuscript_zh_round10.tex").write_text(_finalize_tex(TEX).strip() + "\n", encoding="utf-8")
    (OUT / "README_zh.md").write_text(README, encoding="utf-8")
    (OUT / "missing_assets_zh.txt").write_text("\n".join(missing) + ("\n" if missing else ""), encoding="utf-8")
    print(f"Wrote {OUT}")
...
def _sanitize_bib(path: Path) -> None:
    """Patch draft BibTeX metadata that was intentionally marked incomplete in Round10."""
    ...
    for block in blocks:
        key = ""
        if block.startswith("@") and "{" in block and "," in block:
            key = block.split("{", 1)[1].split(",", 1)[0].strip()
        if key in AUTHOR_FIXES and "\n  author =" not in block:
            ...
            for line in lines:
                ...
                if not inserted and line.strip().startswith("title ="):
                    out_lines.append(f"  author = {{{AUTHOR_FIXES[key]}}},")
                    inserted = True
            block = "\n".join(out_lines)
