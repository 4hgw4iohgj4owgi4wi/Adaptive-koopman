...
SOURCES = [
    ROUND / "e0_nominal_fault_shard_2026_2030" / "data" / "tf14_remaining_runs.csv",
    ROUND / "e0_nominal_fault_shard_2031_2035" / "data" / "tf14_remaining_runs.csv",
    ROUND / "e0_nominal_fault_shard_2036_2040" / "data" / "tf14_remaining_runs.csv",
    ROUND / "e0_nominal_fault_shard_2041_2045" / "data" / "tf14_remaining_runs.csv",
]
OUT = ROUND / "e0_n20_nominal_single_fault_main_comparison_merged"
DATA = OUT / "data"
...
def main() -> None:
    ...
    manifest = {
        "stage": "round10_e0_nominal_single_fault_shard_merge",
