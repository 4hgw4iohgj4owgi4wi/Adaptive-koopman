...
- 已包含实验：`E0`
- 是否达到正式 n>=20：`True`
- 数据目录：`D:\LEARNING\ZNN\ZNN\Adaptive-koopman\Adaptive-koopman-main\paper_dcn_tf12_draft\publication_readiness_round10_2026-05-11\publication_pressure_n20_akea_bilin_2026-05-12\data`
- 图片目录：`D:\LEARNING\ZNN\ZNN\Adaptive-koopman\Adaptive-koopman-main\paper_dcn_tf12_draft\publication_readiness_round10_2026-05-11\publication_pressure_n20_akea_bilin_2026-05-12\figures`
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| E0 | sine_publication_mixed_pressure | ake_a_bilinear_ridge | 20 | 0.1354 | 14.1775 | 0.000 | 0.1516 | 0.177 | -2.059e+00 |
