...
SOURCES = [
    ROUND / "e0_comm_key_shard_2026_2030" / "data" / "tf14_remaining_runs.csv",
    ROUND / "e0_comm_key_shard_2031_2035" / "data" / "tf14_remaining_runs.csv",
    ROUND / "e0_comm_key_shard_2036_2040" / "data" / "tf14_remaining_runs.csv",
    ROUND / "e0_comm_key_shard_2041_2045" / "data" / "tf14_remaining_runs.csv",
]
OUT = ROUND / "e0_n20_comm_noise_key_main_comparison_merged"
DATA = OUT / "data"
...
def main() -> None:
    ...
    manifest = {
        "stage": "round10_e0_comm_key_shard_merge",
