...
- 已包含实验：`E0`
- 是否达到正式 n>=20：`False`
- 数据目录：`D:\LEARNING\ZNN\ZNN\Adaptive-koopman\Adaptive-koopman-main\paper_dcn_tf12_draft\publication_readiness_round10_2026-05-11\publication_pressure_ake_smoke_2026-05-12\data`
- 图片目录：`D:\LEARNING\ZNN\ZNN\Adaptive-koopman\Adaptive-koopman-main\paper_dcn_tf12_draft\publication_readiness_round10_2026-05-11\publication_pressure_ake_smoke_2026-05-12\figures`
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| E0 | sine_publication_mixed_pressure | ake_a_bilinear_ridge | 1 | 0.1521 | 14.1592 | 0.000 | 0.2649 | 0.177 | -2.058e+00 |
| E0 | sine_publication_mixed_pressure | ake_a_linear_net | 1 | 0.1707 | 14.2948 | 0.000 | 0.1205 | 0.177 | -2.191e+00 |
