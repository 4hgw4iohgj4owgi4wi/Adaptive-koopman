...
- 已包含实验：`E0`
- 是否达到正式 n>=20：`True`
- 数据目录：`D:\LEARNING\ZNN\ZNN\Adaptive-koopman\Adaptive-koopman-main\paper_dcn_tf12_draft\publication_readiness_round10_2026-05-11\publication_pressure_n20_tf14full_2026-05-12\data`
- 图片目录：`D:\LEARNING\ZNN\ZNN\Adaptive-koopman\Adaptive-koopman-main\paper_dcn_tf12_draft\publication_readiness_round10_2026-05-11\publication_pressure_n20_tf14full_2026-05-12\figures`
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| E0 | sine_publication_mixed_pressure | tf14_phase_role | 20 | 0.0415 | 0.4663 | 1.000 | 0.1467 | 1.000 | 2.849e-03 |
