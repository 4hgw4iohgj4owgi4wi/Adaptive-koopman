...
$\norm{A^+}_2+\sum_\ell \bar u_\ell\norm{N_\ell^+}_2\le r_u$. Let the state-dependent residual gain be small enough to be absorbed by the certificate decrease, i.e.,
\begin{equation}
