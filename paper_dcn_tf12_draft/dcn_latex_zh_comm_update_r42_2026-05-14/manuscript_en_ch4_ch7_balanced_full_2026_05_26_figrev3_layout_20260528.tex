...
Experiment 11 reports paired $n=20$ certificate statistics on the 5 m/s sine path. The compact certificate summary is as follows: nominal clean, high-communication-noise, single-fault, and mixed fault/noise all have full-path rate $1.00$; their certificate-ok ratios are $0.360$, $1.000$, $0.799$, and $1.000$, and their minimum margins are $-0.0224$, $0.0049$, $-0.0111$, and $0.0033$, respectively. The tabulated version is retained as Supplementary Table S1. Thus, high communication noise and mixed fault/noise have positive aggregate margins and certificate ok ratio $1.0$, whereas nominal clean and single fault contain negative worst-case margins. The corresponding mode-wise logs further show positive margins for the nominal and FTC-flagged steps in the communication-stress scenarios.
