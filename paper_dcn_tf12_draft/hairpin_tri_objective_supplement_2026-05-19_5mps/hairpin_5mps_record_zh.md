...
- 方法：Baseline Koopman-MPC, BKC-DCMPC (ours), BKC-DCMPC tri-objective。

## 汇总结果

| 方法 | n | 成功率 | 横向RMSE(m) | 纵向RMSE(m) | 连接利用率 | 证书通过率 | 力峰值(N) | 力RMS(N) |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| Baseline Koopman-MPC | 3 | 1.000 | 0.4042 | 8.5442 | 1.000 | 0.242 | 11583.2 | 2586.6 |
| BKC-DCMPC (ours) | 3 | 1.000 | 0.3635 | 3.9146 | 0.278 | 0.768 | 8116.5 | 3024.9 |
| BKC-DCMPC tri-objective | 3 | 1.000 | 0.3553 | 3.3075 | 0.122 | 0.802 | 5813.8 | 2777.6 |
